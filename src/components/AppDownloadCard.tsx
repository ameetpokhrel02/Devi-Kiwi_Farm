...
const AppDownloadCard: React.FC = () => {
  return (
    <div className="bg-gradient-to-br from-orange-200 via-pink-200 to-pink-300 rounded-2xl shadow-lg p-6 w-full max-w-xs mx-auto flex flex-col items-center">
      <div className="flex items-center mb-2">
        <img src={kiwiLogo} alt="Kiwi Logo" className="w-10 h-10 mr-2 rounded-full bg-white p-1 shadow" />
        <span className="font-bold text-lg text-gray-800">Download the App</span>
      </div>
      <div className="bg-white/80 rounded-xl p-3 w-full mb-4">
        <div className="flex items-center mb-1">
          <span className="bg-yellow-400 text-xs font-bold px-2 py-0.5 rounded mr-2">★ 4.8 Rated</span>
          <span className="font-semibold text-sm text-gray-700">Download App</span>
        </div>
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          <span className="text-xs font-medium text-gray-700">Limited Time</span>
        </div>
      </div>
      {/* QR code placeholder */}
      <div className="bg-white rounded-lg p-2 mb-3 shadow">
        <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=https://devi-kiwi-farm.com" alt="QR Code" className="w-20 h-20" />
      </div>
      <div className="flex flex-col gap-2 w-full mb-2">
        ...
        <a href="#" className="flex items-center justify-center bg-white border border-gray-300 text-gray-800 rounded-lg py-2 font-semibold text-sm hover:bg-gray-100 transition">
      ...
      <span className="text-xs text-gray-600 mt-2">Download the App Now!</span>
    </div>
  );
};
