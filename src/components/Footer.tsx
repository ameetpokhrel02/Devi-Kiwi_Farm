          ...
          <div className="lg:col-span-1 animate-slide-up">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="opacity-80">1247 Valley Road, Orchard Hills, CA 93420</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-accent flex-shrink-0" />
                <span className="opacity-80">(555) 123-KIWI</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-accent flex-shrink-0" />
                <span className="opacity-80">hello@kiwivalefarm.com</span>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="opacity-60 text-sm">
              © 2024 KiwiVale Farm. All rights reserved. | Certified Organic by CCOF
            </p>
